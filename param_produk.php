  ...
  $data = [ 
                "data_m_menu_category_y" => [
                    [
                        ...
                        "updated_by" => "User2",
                        "parent_id" => "",
                        "summary" => "Summary for Category Y1",
                        "data_m_menu_category_n" => [
                            [
                                ...
                                "updated_by" => "User2",
                                "parent_id" => "1",
                                "summary" => "Summary for Category N1",
                                "data_m_product_menu"=> []
                            ]
                        ],
                        [
                            ...
                            "updated_by" => " User2",
                            "parent_id" => "",
                            "summary" => "Summary for Category Y2",
                            "data_m_menu_category_n" => []
                        ],
                        [
                            "id_y" => "3",
                            ...
                            "updated_by" => "User2",
                            "parent_id" => "",
                            "summary" => "Summary for Category Y3",
                            "data_m_menu_category_n" => [
                                [
                                    "id_n" => "1",
                                    "name" => "Category N1",
                                ...
                                [
                                    ...
                                    "updated_by" => "User2",
                                    "parent_id" => "3",
                                    "summary" => "Summary for Category N2",
                                    "data_m_product_menu" => [
                                        [
                                            "id_m_product_menu" => "3",
                                            "product_id" => "Product3",
